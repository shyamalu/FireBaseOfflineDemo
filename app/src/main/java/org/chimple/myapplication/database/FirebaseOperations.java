...
import static org.chimple.myapplication.database.Helper.FB_SELECTED_SCHOOL;
...
public class FirebaseOperations {
    ...
    private void removeAllSyncListeners() {
    ...
    private void initListeners(String schoolId) {
